import { has } from './../../../../../node_modules/@langchain/openai/node_modules/openai/src/internal/qs/utils';
/**
 * ===============================================
...
export async function GET() {
  try {
    ...
    // ปรับค่าตรงนี้ตามความเหมาะสมของข้อมูล จะมีผลต่อความแม่นยำและต้นทุน
    // ===============================================
    const splitter = new RecursiveCharacterTextSplitter({
        chunkSize: 500,    // เพิ่มขนาด chunk สำหรับข้อมูลที่ซับซ้อนมากขึ้น
        chunkOverlap: 100, // เพิ่ม overlap เพื่อรักษาบริบท ให้มันช่วงหาเจอได้ง่าย มีคว่ามเชื่อมโยงกับ Text ก่อนหน้า ปกติ 20-50% ก็พอ
        separators: ["\n\n", "\n", ",", " "], // ตัวแบ่งหลายระดับ
    });
